...
![Figure 1. Age, Episode Count & Sex Distribution](../img/univariate_visualization.png){#fig-univariate width=105%}
...
![Figure 2. Relationship of Features with Outcome](../results/figures/multivariate_visualization.png){#fig-multivariate width=90%}
...
![Figure 3. Feature Correlation Heatmap](../results/figures/correlation_heatmap.png){#fig-corr width=70%}
...
![Figure 4. SHAP Feature Importance Summary](../results/figures/shap_values_plot.png){#fig-shap width=90%}
