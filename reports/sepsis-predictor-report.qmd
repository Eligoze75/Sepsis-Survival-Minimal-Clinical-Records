...
coef = pd.read_csv("../data/logistic_coefficients.csv")

intercept = coef.loc[coef.feature=="intercept","coef"].item()
age_coef = coef.loc[coef.feature=="age_in_years","coef"].item()
episode_coef = coef.loc[coef.feature=="episode_number","coef"].item()
sex_coef = coef.loc[coef.feature=="sex","coef"].item()
```
...
top1 = shap_importance_sorted.iloc[0]
top2 = shap_importance_sorted.iloc[1]
bottom = shap_importance_sorted.iloc[-1]
```
